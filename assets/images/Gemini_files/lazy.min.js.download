...
r("Symbol",function(a){if(a)return a;var b=function(g,f){this.vc=g;ba(this,"description",{configurable:!0,writable:!0,value:f})};b.prototype.toString=function(){return this.vc};var c="jscomp_symbol_"+(Math.random()*1E9>>>0)+"_",d=0,e=function(g){if(this instanceof e)throw new TypeError("Symbol is not a constructor");return new b(c+(g||"")+"_"+d++,g)};return e});
...
!1}h?this.cd(f):this.cc(f)}};e.prototype.cd=function(f){var h=void 0;try{h=f.then}catch(k){this.Cb(k);return}typeof h=="function"?this.jd(h,f):this.cc(f)};e.prototype.Cb=function(f){this.rc(2,f)};e.prototype.cc=function(f){this.rc(1,f)};e.prototype.rc=function(f,h){if(this.l!=0)throw Error("Cannot settle("+f+", "+h+"): Promise already settled in state"+this.l);this.l=f;this.u=h;this.l===2&&this.fd();this.Kc()};e.prototype.fd=function(){var f=this;d(function(){if(f.Tc()){var h=da.console;typeof h!==
"undefined"&&h.error(f.u)}},1)};e.prototype.Tc=function(){if(this.hc)return!1;var f=da.CustomEvent,h=da.Event,k=da.dispatchEvent;if(typeof k==="undefined")return!0;typeof f==="function"?f=new f("unhandledrejection",{cancelable:!0}):typeof h==="function"?f=new h("unhandledrejection",{cancelable:!0}):(f=da.document.createEvent("CustomEvent"),f.initCustomEvent("unhandledrejection",!1,!0,f));f.promise=this;f.reason=this.u;return k(f)};e.prototype.Kc=function(){if(this.la!=null){for(var f=0;f<this.la.length;++f)g.Vb(this.la[f]);
...
break;case 2:h(l.u);break;default:throw Error("Unexpected state: "+l.l);}}var l=this;this.la==null?g.Vb(k):this.la.push(k);this.hc=!0};e.resolve=c;e.reject=function(f){return new e(function(h,k){k(f)})};e.race=function(f){return new e(function(h,k){for(var l=v(f),n=l.next();!n.done;n=l.next())c(n.value).Na(h,k)})};e.all=function(f){var h=v(f),k=h.next();return k.done?c([]):new e(function(l,n){function q(z){return function(C){t[z]=C;p--;p==0&&l(t)}}var t=[],p=0;do t.push(void 0),p++,c(k.value).Na(q(t.length-
1),n),k=h.next();while(!k.done)})};return e});r("Symbol.dispose",function(a){return a?a:Symbol("Symbol.dispose")});r("Array.prototype.find",function(a){return a?a:function(b,c){a:{var d=this;d instanceof String&&(d=String(d));for(var e=d.length,g=0;g<e;g++){var f=d[g];if(b.call(c,f,g,d)){b=f;break a}}b=void 0}return b}});
...
l=null}return{done:!0,value:void 0}})},g=function(){var h={};return h.N=h.next=h.head=h},f=0;return c});r("Object.values",function(a){return a?a:function(b){var c=[],d;for(d in b)w(b,d)&&c.push(b[d]);return c}});r("Object.is",function(a){return a?a:function(b,c){return b===c?b!==0||1/b===1/c:b!==b&&c!==c}});
...
var wb=qb?function(a,b){a[tb]|=b}:function(a,b){a.T!==void 0?a.T|=b:Object.defineProperties(a,{T:{value:b,configurable:!0,writable:!0,enumerable:!1}})},xb=qb?function(a){return a[tb]|0}:function(a){return a.T|0},G=qb?function(a){return a[tb]}:function(a){return a.T},H=qb?function(a,b){a[tb]=b;return a}:function(a,b){a.T!==void 0?a.T=b:Object.defineProperties(a,{T:{value:b,configurable:!0,writable:!0,enumerable:!1}});return a};function yb(a,b){H(b,(a|0)&-14591)}
function zb(a,b){H(b,(a|34)&-14557)}function Ab(a){a=a>>14&1023;return a===0?536870912:a};var Bb={},Cb={};function Db(a){return!(!a||typeof a!=="object"||a.Md!==Cb)}function Eb(a){return a!==null&&typeof a==="object"&&!Array.isArray(a)&&a.constructor===Object}function Fb(a,b,c){if(!Array.isArray(a)||a.length)return!1;var d=xb(a);if(d&1)return!0;if(!(b&&(Array.isArray(b)?b.includes(c):b.has(c))))return!1;H(a,d|1);return!0}var Gb,Hb=[];H(Hb,55);Gb=Object.freeze(Hb);function Ib(a){if(a&2)throw Error();}var Jb=function(){},Kb=Object.freeze(new function(){});Object.freeze(new Jb);var Lb=Object.freeze(new Jb);var Mb=function(a,b){a.__closure__error__context__984382||(a.__closure__error__context__984382={});a.__closure__error__context__984382.severity=b};var Nb;function Ob(){var a=Error();Mb(a,"incident");Na(a)}function Pb(a){a=Error(a);Mb(a,"warning");return a};var I=0,J=0;function Qb(a){var b=a<0;a=Math.abs(a);var c=a>>>0;a=Math.floor((a-c)/4294967296);b&&(c=v(Rb(c,a)),b=c.next().value,a=c.next().value,c=b);I=c>>>0;J=a>>>0}function Sb(a,b){b>>>=0;a>>>=0;if(b<=2097151)var c=""+(4294967296*b+a);else ob()?c=""+(BigInt(b)<<BigInt(32)|BigInt(a)):(c=(a>>>24|b<<8)&16777215,b=b>>16&65535,a=(a&16777215)+c*6777216+b*6710656,c+=b*8147497,b*=2,a>=1E7&&(c+=Math.floor(a/1E7),a%=1E7),c>=1E7&&(b+=Math.floor(c/1E7),c%=1E7),c=b+Tb(c)+Tb(a));return c}
function Tb(a){a=String(a);return"0000000".slice(a.length)+a}function Ub(){var a=I,b=J;b&2147483648?ob()?a=""+(BigInt(b|0)<<BigInt(32)|BigInt(a>>>0)):(b=v(Rb(a,b)),a=b.next().value,b=b.next().value,a="-"+Sb(a,b)):a=Sb(a,b);return a}function Rb(a,b){b=~b;a?a=~a+1:b+=1;return[a,b]};function Vb(a){return a.displayName||a.name||"unknown type name"}var Wb=/^-?([1-9][0-9]*|0)(\.[0-9]+)?$/;function Xb(a){var b=typeof a;return b==="number"?Number.isFinite(a):b!=="string"?!1:Wb.test(a)}function Yb(a){if(!Number.isFinite(a))throw Pb("enum");return a|0}function Zb(a){return a==null?a:Number.isFinite(a)?a|0:void 0}function $b(a){if(typeof a!=="number")throw Pb("int32");if(!Number.isFinite(a))throw Pb("int32");return a|0}
function ac(a){return a[0]==="-"?a.length<20?!0:a.length===20&&Number(a.substring(0,7))>-922337:a.length<19?!0:a.length===19&&Number(a.substring(0,6))<922337}function bc(a){Xb(a);a=Math.trunc(a);if(!Number.isSafeInteger(a)){Qb(a);var b=I,c=J;if(a=c&2147483648)b=~b+1>>>0,c=~c>>>0,b==0&&(c=c+1>>>0);b=c*4294967296+(b>>>0);a=a?-b:b}return a}
function cc(a){Xb(a);var b=Math.trunc(Number(a));if(Number.isSafeInteger(b))return String(b);b=a.indexOf(".");b!==-1&&(a=a.substring(0,b));if(!ac(a)){if(a.length<16)Qb(Number(a));else if(ob())a=BigInt(a),I=Number(a&BigInt(4294967295))>>>0,J=Number(a>>BigInt(32)&BigInt(4294967295));else{b=+(a[0]==="-");J=I=0;for(var c=a.length,d=0+b,e=(c-b)%6+b;e<=c;d=e,e+=6)d=Number(a.slice(d,e)),J*=1E6,I=I*1E6+d,I>=4294967296&&(J+=Math.trunc(I/4294967296),J>>>=0,I>>>=0);b&&(b=v(Rb(I,J)),a=b.next().value,b=b.next().value,
I=a,J=b)}a=Ub()}return a}function dc(a){if(typeof a!=="string")throw Error();return a}function ec(a){if(a!=null&&typeof a!=="string")throw Error();return a}function fc(a){return a==null||typeof a==="string"?a:void 0};var gc;function hc(a,b){gc=b;a=new a(b);gc=void 0;return a}
function K(a,b,c){a==null&&(a=gc);gc=void 0;if(a==null){var d=96;c?(a=[c],d|=512):a=[];b&&(d=d&-16760833|(b&1023)<<14)}else{if(!Array.isArray(a))throw Error("narr");d=xb(a);if(d&2048)throw Error("farr");if(d&64)return a;d|=64;if(c&&(d|=512,c!==a[0]))throw Error("mid");a:{c=a;var e=c.length;if(e){var g=e-1;if(Eb(c[g])){d|=256;b=g-(+!!(d&512)-1);if(b>=1024)throw Error("pvtlmt");d=d&-16760833|(b&1023)<<14;break a}}if(b){b=Math.max(b,e-(+!!(d&512)-1));if(b>1024)throw Error("spvt");d=d&-16760833|(b&1023)<<
14}}}H(a,d);return a};function ic(a,b){return jc(b)}function jc(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "boolean":return a?1:0;case "object":if(a)if(Array.isArray(a)){if(Fb(a,void 0,0))return}else if(mb&&a!=null&&a instanceof Uint8Array){if(nb){for(var b="",c=0,d=a.length-10240;c<d;)b+=String.fromCharCode.apply(null,a.subarray(c,c+=10240));b+=String.fromCharCode.apply(null,c?a.subarray(c):a);a=btoa(b)}else a=kb(a);return a}}return a};function kc(a,b,c){a=pb(a);var d=a.length,e=b&256?a[d-1]:void 0;d+=e?-1:0;for(b=b&512?1:0;b<d;b++)a[b]=c(a[b]);if(e){b=a[b]={};for(var g in e)b[g]=c(e[g])}return a}function lc(a,b,c,d,e){if(a!=null){if(Array.isArray(a))a=Fb(a,void 0,0)?void 0:e&&xb(a)&2?a:mc(a,b,c,d!==void 0,e);else if(Eb(a)){var g={},f;for(f in a)g[f]=lc(a[f],b,c,d,e);a=g}else a=b(a,d);return a}}
function mc(a,b,c,d,e){var g=d||c?xb(a):0;d=d?!!(g&32):void 0;a=pb(a);for(var f=0;f<a.length;f++)a[f]=lc(a[f],b,c,d,e);c&&c(g,a);return a}function nc(a){return a.zb===Bb?a.toJSON():jc(a)};function oc(a,b,c){c=c===void 0?zb:c;if(a!=null){if(mb&&a instanceof Uint8Array)return b?a:new Uint8Array(a);if(Array.isArray(a)){var d=xb(a);d&2||(b&&(b=d===0||!!(d&32)&&!(d&64||!(d&16))),a=b?H(a,(d|34)&-12293):mc(a,oc,d&4?zb:c,!0,!0));return a}a.zb===Bb&&(c=a.g,d=G(c),a=d&2?a:hc(a.constructor,pc(c,d,!0)));return a}}function pc(a,b,c){var d=c||b&2?zb:yb,e=!!(b&32);a=kc(a,b,function(g){return oc(g,e,d)});wb(a,32|(c?2:0));return a};function qc(a,b,c,d){if(!(4&b))return!0;if(c==null)return!1;!d&&c===0&&(4096&b||8192&b)&&(a.constructor[vb]=(a.constructor[vb]|0)+1)<5&&Ob();return c===0?!1:!(c&b)}var sc=function(a,b){a=a.g;return rc(a,G(a),b)};function tc(a,b,c,d){b=d+(+!!(b&512)-1);if(!(b<0||b>=a.length||b>=c))return a[b]}
var rc=function(a,b,c,d){if(c===-1)return null;var e=Ab(b);if(c>=e){if(b&256)return a[a.length-1][c]}else{var g=a.length;if(d&&b&256&&(d=a[g-1][c],d!=null)){if(tc(a,b,e,c)&&ub!=null){var f;a=(f=Nb)!=null?f:Nb={};f=a[ub]||0;f>=4||(a[ub]=f+1,Ob())}return d}return tc(a,b,e,c)}},vc=function(a,b,c){var d=a.g,e=G(d);Ib(e);uc(d,e,b,c);return a};
function uc(a,b,c,d,e){var g=Ab(b);if(c>=g||e&&!Sa){var f=b;if(b&256)e=a[a.length-1];else{if(d==null)return f;e=a[g+(+!!(b&512)-1)]={};f|=256}e[c]=d;c<g&&(a[c+(+!!(b&512)-1)]=void 0);f!==b&&H(a,f);return f}a[c+(+!!(b&512)-1)]=d;b&256&&(a=a[a.length-1],c in a&&delete a[c]);return b}
function wc(a,b,c,d,e){var g=a.g,f=G(g);d=2&f?1:d;e=!!e;var h=rc(g,f,b);h=Array.isArray(h)?h:Gb;var k=xb(h);if(qc(a,k,void 0,e)){if(4&k||Object.isFrozen(h))h=pb(h),k=xc(k,f),f=uc(g,f,b,h);for(var l=a=0;a<h.length;a++){var n=c(h[a]);n!=null&&(h[l++]=n)}l<a&&(h.length=l);c=k;c===0&&(c=xc(c,f));k=c|21;k&=-12289;H(h,k);2&k&&Object.freeze(h)}2&k&&4&k||2048&k||(c=k,k=(a=d===1||d===4&&!!(32&k))?k|2:yc(k,f,e),k!==c&&H(h,k),a&&Object.freeze(h));d===2&&(2&k&&4&k||2048&k)&&(h=pb(h),k=xc(k,f),k=yc(k,f,e),H(h,
k),uc(g,f,b,h));return h}function zc(a,b,c,d){var e=a.g,g=G(e);Ib(g);if(c==null)return uc(e,g,b),a;if(!Array.isArray(c))throw Pb();var f=xb(c),h=f,k=!!(2&f)||Object.isFrozen(c),l=!k&&(void 0===Lb||!1);if(qc(a,f))for(f=21,k&&(c=pb(c),h=0,f=xc(f,g),f=yc(f,g,!0)),k=0;k<c.length;k++)c[k]=d(c[k]);l&&(c=pb(c),h=0,f=xc(f,g),f=yc(f,g,!0));f!==h&&H(c,f);uc(e,g,b,c);return a}function L(a,b,c,d){var e=a.g,g=G(e);Ib(g);uc(e,g,b,(d==="0"?Number(c)===0:c===d)?void 0:c);return a}
function Ac(a,b,c,d){a=a.g;var e=G(a),g=rc(a,e,c,d);if(g!=null&&typeof g==="object"&&g.zb===Bb)b=g;else if(Array.isArray(g)){var f=xb(g),h=f;h===0&&(h|=e&32);h|=e&2;h!==f&&H(g,h);b=new b(g)}else b=void 0;b!==g&&b!=null&&uc(a,e,c,b,d);return b}
var M=function(a,b,c){var d=d===void 0?!1:d;b=Ac(a,b,c,d);if(b==null)return b;a=a.g;var e=G(a);if(!(e&2)){var g=b;var f=g.g,h=G(f);g=h&2?hc(g.constructor,pc(f,h,!1)):g;g!==b&&(b=g,uc(a,e,c,b,d))}return b},N=function(a,b,c,d){if(d!=null){if(!(d instanceof b))throw Error("Expected instanceof "+Vb(b)+" but got "+(d&&Vb(d.constructor)));}else d=void 0;return vc(a,c,d)};function xc(a,b){a=(2&b?a|2:a&-3)|32;return a&=-2049}function yc(a,b,c){32&b&&c||(a&=-33);return a}
var O=function(a,b){var c=c===void 0?!1:c;a=sc(a,b);a=a==null||typeof a==="boolean"?a:typeof a==="number"?!!a:void 0;return a!=null?a:c},Bc=function(a){var b=b===void 0?0:b;a=sc(a,1);a=a==null?a:Xb(a)?typeof a==="number"?bc(a):cc(a):void 0;return a!=null?a:b},Cc=function(a,b){var c=c===void 0?"":c;a=fc(sc(a,b));return a!=null?a:c},Dc=function(a,b,c){a=wc(a,b,fc,3,!0);if(typeof c!=="number"||c<0||c>=a.length)throw Error();return a[c]},P=function(a,b,c){if(c!=null&&typeof c!=="boolean")throw Error("Expected boolean but got "+
Fa(c)+": "+c);return L(a,b,c,!1)};var Ec,Q=function(a,b,c){this.g=K(a,b,c)};Q.prototype.toJSON=function(){return Fc(this)};var Gc=function(a){try{return Ec=!0,JSON.stringify(Fc(a),ic)}finally{Ec=!1}},Hc=function(a,b){if(b==null||b=="")return new a;b=JSON.parse(b);if(!Array.isArray(b))throw Error("dnarr");wb(b,32);return hc(a,b)};m=Q.prototype;
m.getExtension=function(a){var b=a.ba?a.Pc?a.ya(this,a.ba,a.ea,void 0!==Kb?4:2,!0):a.ya(this,a.ba,a.ea,!0):a.Pc?a.ya(this,a.ea,void 0!==Kb?4:2,!0):a.ya(this,a.ea,a.defaultValue,!0);return a.Ld&&b==null?a.defaultValue:b};m.hasExtension=function(a){a.ba?a=Ac(this,a.ba,a.ea,!0)!==void 0:(a=a.ba?a.ya(this,a.ba,a.ea,!0):a.ya(this,a.ea,null,!0),a=(a===null?void 0:a)!==void 0);return a};m.clone=function(){var a=this.g;return hc(this.constructor,pc(a,G(a),!1))};m.zb=Bb;
m.toString=function(){try{return Ec=!0,Fc(this).toString()}finally{Ec=!1}};
function Fc(a){var b=Ec?a.g:mc(a.g,nc,void 0,void 0,!1);var c=!Ec;var d=Ra?void 0:a.constructor.B;var e=G(c?a.g:b);if(a=b.length){var g=b[a-1],f=Eb(g);f?a--:g=void 0;e=+!!(e&512)-1;var h=b;if(f){b:{var k=g;var l={};f=!1;if(k)for(var n in k)if(isNaN(+n))l[n]=k[n];else{var q=k[n];Array.isArray(q)&&(Fb(q,d,+n)||Db(q)&&q.size===0)&&(q=null);q==null&&(f=!0);q!=null&&(l[n]=q)}if(f){for(var t in l)break b;l=null}else l=k}k=l==null?g!=null:l!==g}for(var p;a>0;a--){t=a-1;n=h[t];t-=e;if(!(n==null||Fb(n,d,t)||
Db(n)&&n.size===0))break;p=!0}if(h!==b||k||p){if(!c)h=Array.prototype.slice.call(h,0,a);else if(p||k||l)h.length=a;l&&h.push(l)}b=h}return b};try{(new self.OffscreenCanvas(0,0)).getContext("2d")}catch(a){};var Ic=function(){return!0},Jc=function(){};function Kc(a,b){for(var c in a)b.call(void 0,a[c],c,a)}function Lc(a,b){for(var c in a)if(b.call(void 0,a[c],c,a))return!0;return!1}var Mc="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Nc(a,b){for(var c,d,e=1;e<arguments.length;e++){d=arguments[e];for(c in d)a[c]=d[c];for(var g=0;g<Mc.length;g++)c=Mc[g],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}};var Qc=function(a,b){this.sc=a===Oc&&b||"";this.wc=Pc};Qc.prototype.toString=function(){return this.sc};var Rc=function(a){return a instanceof Qc&&a.constructor===Qc&&a.wc===Pc?a.sc:"type_error:Const"},R=function(a){return new Qc(Oc,a)},Pc={},Oc={};var Sc;var Tc=function(a){this.nc=a};Tc.prototype.toString=function(){return this.nc+""};
var Uc=function(a){return a instanceof Tc&&a.constructor===Tc?a.nc:"type_error:TrustedResourceUrl"},Yc=function(a,b){var c=Rc(a);if(!Vc.test(c))throw Error("Invalid TrustedResourceUrl format: "+c);a=c.replace(Wc,function(d,e){if(!Object.prototype.hasOwnProperty.call(b,e))throw Error('Found marker, "'+e+'", in format string, "'+c+'", but no valid label mapping found in args: '+JSON.stringify(b));d=b[e];return d instanceof Qc?Rc(d):encodeURIComponent(String(d))});return Xc(a)},Wc=/%{(\w+)}/g,Vc=RegExp("^((https:)?//[0-9a-z.:[\\]-]+/|/[^/\\\\]|[^:/\\\\%]+/|[^:/\\\\%]*[?#]|about:blank#)",
"i"),Zc={},Xc=function(a){if(Sc===void 0){var b=null;var c=y.trustedTypes;if(c&&c.createPolicy)try{b=c.createPolicy("uf-la#html",{createHTML:La,createScript:La,createScriptURL:La})}catch(d){y.console&&y.console.error(d.message)}Sc=b}a=(b=Sc)?b.createScriptURL(a):a;return new Tc(a,Zc)};/*

 SPDX-License-Identifier: Apache-2.0
*/
var $c=function(a){this.oc=a};$c.prototype.toString=function(){return this.oc};var ad=new $c("about:invalid#zClosurez");function bd(a){if(a instanceof $c)return a.oc;throw Error("");};var cd=function(a){this.Qc=a};function dd(a){return new cd(function(b){return b.substr(0,a.length+1).toLowerCase()===a+":"})}var ed=[dd("data"),dd("http"),dd("https"),dd("mailto"),dd("ftp"),new cd(function(a){return/^[^:]*([/?#]|$)/.test(a)})];function fd(a){var b=b===void 0?ed:b;a:if(b=b===void 0?ed:b,!(a instanceof $c)){for(var c=0;c<b.length;++c){var d=b[c];if(d instanceof cd&&d.Qc(a)){a=new $c(a);break a}}a=void 0}return a||ad}var gd=/^\s*(?!javascript:)(?:[\w+.-]+:|[^:/?#]*(?:[/?#]|$))/i;
...
T.prototype.cancel=function(a){if(this.l==0){var b=new Ud(a);Jd(function(){Vd(this,b)},this)}};
...
c.call(d,h);k===void 0&&h instanceof Ud?f(h):g(k)}catch(l){f(l)}}:f});e.V.v=a;Zd(a,e);return e.V};T.prototype.od=function(a){this.l=0;Md(this,2,a)};T.prototype.pd=function(a){this.l=0;Md(this,3,a)};
...
k))};try{b.call(a,f,h)}catch(k){h(k)}},Yd=function(a){a.rb||(a.rb=!0,Jd(a.Ic,a))},Wd=function(a){var b=null;a.S&&(b=a.S,a.S=b.next,b.next=null);a.S||(a.aa=null);return b};T.prototype.Ic=function(){for(var a;a=Wd(this);)Xd(this,a,this.l,this.u);this.rb=!1};
...
m.va=function(){ag.oa.va.call(this);if(this.F){var a=this.F,b=0,c;for(c in a.s){for(var d=a.s[c],e=0;e<d.length;e++)++b,Ff(d[e]);delete a.s[c];a.Ka--}}this.Ab=null};m.listen=function(a,b,c,d){return this.F.add(String(a),b,!1,c,d)};var bg=function(a,b,c,d){b=a.F.s[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,g=0;g<b.length;++g){var f=b[g];if(f&&!f.Fa&&f.capture==c){var h=f.listener,k=f.Wa||f.src;f.Ma&&If(a.F,f);e=h.call(k,d)!==!1&&e}}return e&&!d.defaultPrevented};
ag.prototype.tb=function(a,b,c,d){return this.F.tb(String(a),b,c,d)};ag.prototype.hasListener=function(a,b){return this.F.hasListener(a!==void 0?String(a):void 0,b)};var cg=function(a){try{return y.JSON.parse(a)}catch(b){}a=String(a);if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);};var dg=function(){};dg.prototype.Xb=null;var eg=function(a){var b;(b=a.Xb)||(b=a.Xb={});return b};var fg,gg=function(){};D(gg,dg);fg=new gg;var hg=function(a,b,c){if(typeof a==="function")c&&(a=B(a,c));else if(a&&typeof a.handleEvent=="function")a=B(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(b)>2147483647?-1:y.setTimeout(a,b||0)};var ig=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$"),jg=function(a,b){if(a){a=a.split("&");for(var c=0;c<a.length;c++){var d=a[c].indexOf("="),e=null;if(d>=0){var g=a[c].substring(0,d);e=a[c].substring(d+1)}else g=a[c];b(g,e?decodeURIComponent(e.replace(/\+/g," ")):"")}}};var W=function(a){ag.call(this);this.headers=new Map;this.uc=a||null;this.P=!1;this.jb=this.h=null;this.yb="";this.X=this.wb=this.Za=this.qb=!1;this.Sb=0;this.fb=null;this.pc="";this.Xc=this.Ub=!1;this.mb=this.Tb=null};D(W,ag);var kg=/^https?$/i,lg=["POST","PUT"],mg=[],ng=function(a,b,c,d,e,g){var f=new W;mg.push(f);b&&f.listen("complete",b);f.F.add("ready",f.Dc,!0,void 0,void 0);g&&(f.Sb=Math.max(0,g));f.Ub=!0;f.send(a,c,d,e)};m=W.prototype;m.Dc=function(){this.dispose();bb(mg,this)};
m.setTrustToken=function(a){this.Tb=a};m.setAttributionReporting=function(a){this.mb=a};
m.send=function(a,b,c,d){if(this.h)throw Error("[goog.net.XhrIo] Object is active with another request="+this.yb+"; newUri="+a);b=b?b.toUpperCase():"GET";this.yb=a;this.qb=!1;this.P=!0;this.h=new XMLHttpRequest;this.jb=this.uc?eg(this.uc):eg(fg);this.h.onreadystatechange=B(this.mc,this);this.Xc&&"onprogress"in this.h&&(this.h.onprogress=B(function(f){this.lc(f,!0)},this),this.h.upload&&(this.h.upload.onprogress=B(this.lc,this)));try{this.wb=!0,this.h.open(b,String(a),!0),this.wb=!1}catch(f){this.Pa(5,
f);return}a=c||"";c=new Map(this.headers);if(d)if(Object.getPrototypeOf(d)===Object.prototype)for(var e in d)c.set(e,d[e]);else if(typeof d.keys==="function"&&typeof d.get==="function"){e=v(d.keys());for(var g=e.next();!g.done;g=e.next())g=g.value,c.set(g,d.get(g))}else throw Error("Unknown input type for opt_headers: "+String(d));d=Array.from(c.keys()).find(function(f){return"content-type"==f.toLowerCase()});e=y.FormData&&a instanceof y.FormData;!(Za(lg,b)>=0)||d||e||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");
b=v(c);for(d=b.next();!d.done;d=b.next())c=v(d.value),d=c.next().value,c=c.next().value,this.h.setRequestHeader(d,c);this.pc&&(this.h.responseType=this.pc);"withCredentials"in this.h&&this.h.withCredentials!==this.Ub&&(this.h.withCredentials=this.Ub);if("setTrustToken"in this.h&&this.Tb)try{this.h.setTrustToken(this.Tb)}catch(f){}if("setAttributionReporting"in this.h&&this.mb)try{this.h.setAttributionReporting(this.mb)}catch(f){}try{og(this),this.Sb>0&&(this.fb=hg(this.gb,this.Sb,this)),this.Za=!0,
this.h.send(a),this.Za=!1}catch(f){this.Pa(5,f)}};m.gb=function(){typeof Ca!="undefined"&&this.h&&(this.dispatchEvent("timeout"),this.abort(8))};m.Pa=function(){this.P=!1;this.h&&(this.X=!0,this.h.abort(),this.X=!1);pg(this);qg(this)};var pg=function(a){a.qb||(a.qb=!0,a.dispatchEvent("complete"),a.dispatchEvent("error"))};W.prototype.abort=function(){this.h&&this.P&&(this.P=!1,this.X=!0,this.h.abort(),this.X=!1,this.dispatchEvent("complete"),this.dispatchEvent("abort"),qg(this))};
W.prototype.va=function(){this.h&&(this.P&&(this.P=!1,this.X=!0,this.h.abort(),this.X=!1),qg(this,!0));W.oa.va.call(this)};W.prototype.mc=function(){this.isDisposed()||(this.wb||this.Za||this.X?rg(this):this.Uc())};W.prototype.Uc=function(){rg(this)};
var rg=function(a){if(a.P&&typeof Ca!="undefined"&&(!a.jb[1]||sg(a)!=4||tg(a)!=2))if(a.Za&&sg(a)==4)hg(a.mc,0,a);else if(a.dispatchEvent("readystatechange"),sg(a)==4){a.P=!1;try{var b=tg(a);a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break a;default:c=!1}var d;if(!(d=c)){var e;if(e=b===0){var g=String(a.yb).match(ig)[1]||null;!g&&y.self&&y.self.location&&(g=y.self.location.protocol.slice(0,-1));e=!kg.test(g?g.toLowerCase():"")}d=e}d?(a.dispatchEvent("complete"),
a.dispatchEvent("success")):pg(a)}finally{qg(a)}}};W.prototype.lc=function(a,b){this.dispatchEvent(ug(a,"progress"));this.dispatchEvent(ug(a,b?"downloadprogress":"uploadprogress"))};var ug=function(a,b){return{type:b,lengthComputable:a.lengthComputable,loaded:a.loaded,total:a.total}},qg=function(a,b){if(a.h){og(a);var c=a.h,d=a.jb[0]?function(){}:null;a.h=null;a.jb=null;b||a.dispatchEvent("ready");try{c.onreadystatechange=d}catch(e){}}},og=function(a){a.fb&&(y.clearTimeout(a.fb),a.fb=null)};
W.prototype.isActive=function(){return!!this.h};var sg=function(a){return a.h?a.h.readyState:0},tg=function(a){try{return sg(a)>2?a.h.status:-1}catch(b){return-1}},vg=function(a){if(a.h){a=a.h.responseText;a.indexOf(")]}'\n")==0&&(a=a.substring(5));a:{if(y.JSON)try{var b=y.JSON.parse(a);break a}catch(c){}b=cg(a)}return b}};W.prototype.getResponseHeader=function(a){if(this.h&&sg(this)==4)return a=this.h.getResponseHeader(a),a===null?void 0:a};
W.prototype.getAllResponseHeaders=function(){return this.h&&sg(this)>=2?this.h.getAllResponseHeaders()||"":""};var wg=u([""]),xg=u(["https://www.google.com/tools/feedback/help_panel_binary.js"]);function yg(a,b,c,d,e,g){return ya(function(f){return f.return(new Promise(function(h){ng(""+a+"/repeater_help_panel?locale="+b+"&helpContext="+c+"&productId="+d+"&helpcenter="+e+"&openingMode="+g,function(k){k=k.target;var l=null;try{l=Hc(Oe,JSON.stringify(vg(k)))}catch(n){}h(l)})}))})}
function zg(a,b,c,d){var e=a.helpCenterPath.startsWith("/")?a.helpCenterPath.substring(1):a.helpCenterPath,g=Pe(b),f=a.helpPanelMode||0,h=a.fixedHelpPanelContainer,k=a.customHelpPanelContainer;h&&f!==1?h=void 0:f!==1||h&&!O(g,5)||(f=0,h=void 0);k&&f!==2?f=2:f!==2||k&&!a.anchor||(f=0,k=void 0);var l=a.openingMode;if(a.directToGetHelp)l=2;else if(a.supportContentUrl||a.defaultHelpArticleId)l=3;var n=c.document,q=a.nonce,t=M(g,Ne,10)?Qe(M(g,Ne,10))||S(wg):S(xg),p=A("document.location.href",c);!a.helpCenterContext&&
p&&(a.helpCenterContext=p.substring(0,1200));p=!0;if(d){var z=JSON.stringify(d);(p=z.length<=1200)&&(a.psdJson=z)}p||(d={invalidPsd:!0});p=qd(n).createElement("SCRIPT");q&&p.setAttribute("nonce",q);p.onload=function(){c.startHelpPanel({helpcenter:e,apiKey:"testpage",channel:a.channel,context:a.helpCenterContext||c.location.href,defaultHelpArticleFragment:a.defaultHelpArticleFragment,defaultHelpArticleId:a.defaultHelpArticleId,defaultHelpArticleHelpcenterPath:a.defaultHelpArticleHelpcenterPath,directToGetHelp:a.directToGetHelp||
...
function uh(a,b,c,d){if(sh)return sh;var e=qh(a,d);return sh=b.feedbackV2GlobalObject?Promise.resolve(b.feedbackV2GlobalObject):new Promise(function(g,f){var h=ud(document,"SCRIPT");nd(h,e);h.onload=function(){b.feedbackV2GlobalObject?g(b.feedbackV2GlobalObject):f("feedbackV2GlobalObject not found on window.")};h.onerror=function(){f("Feedback binary script tag failed to load: "+e.toString())};c.body.appendChild(h)})}
...
function wh(a,b,c,d){var e,g,f;return ya(function(h){if(h.J==1)return e=Date.now(),ra(h,uh(a,c,d.document,b),2);if(h.J!=3)return g=h.sa,ra(h,g.initializeFeedbackClientAsync(a,e,b,d),3);f=h.sa;f.initiateAloha();return h.return(f)})}
function xh(a,b,c){var d=!0;d=d===void 0?!0:d;var e,g,f,h,k,l,n,q,t,p;return ya(function(z){e=c||y;if((g=b)==null?0:(h=(f=g).getEnableAlohaBinarySplit)==null?0:h.call(f)){k=e;if(k.isFormOpened)throw l=Error("Form is either loading or already opened"),l.name="DuplicateFormError",l;k.isFormOpened=!0;a.callbacks=a.callbacks||{};n=a.callbacks.onClose||function(){};a.callbacks.onClose=function(C){k.isFormOpened=!1;n(C)};try{return z.return(wh(a,b,k,e))}catch(C){throw k.isFormOpened=!1,C;}}else{q=e;if(q.isFormOpened)throw t=
Error("Form is either loading or already opened"),t.name="DuplicateFormError",t;q.isFormOpened=!0;a.callbacks=a.callbacks||{};p=a.callbacks.onClose||function(){};a.callbacks.onClose=function(C){q.isFormOpened=!1;p(C)};try{return z.return(vh(a,b,q,e.document,d))}catch(C){throw q.isFormOpened=!1,C;}}z.J=0})};function yh(a,b){return ya(function(c){return c.return(new Promise(function(d){var e=zh(b!=null?b:"")+"/aloha_form_properties?productId="+a;ng(e,function(g){g=g.target;var f=null;try{f=Hc(kh,JSON.stringify(vg(g)))}catch(h){g=new kh,f=jh(),f=P(f,7,!0),f=P(f,10,!0),f=P(f,12,!0),f=P(f,13,!1),f=P(f,14,!0),f=P(f,15,!0),f=P(f,20,!1),f=N(g,ih,1,f)}d(f)},"GET","",{},2E3)}))})}function zh(a){return lh(a)?a:"https://www.google.com/tools/feedback"};var Ah=function(a,b,c){a.timeOfStartCall=(new Date).getTime();var d=c||y,e=d.document,g=a.nonce||md(d);g&&!a.nonce&&(a.nonce=g);if(a.flow=="help"){var f=A("document.location.href",d);!a.helpCenterContext&&f&&(a.helpCenterContext=f.substring(0,1200));f=!0;if(b&&JSON&&JSON.stringify){var h=JSON.stringify(b);(f=h.length<=1200)&&(a.psdJson=h)}f||(b={invalidPsd:!0})}b=[a,b,c];d.GOOGLE_FEEDBACK_START_ARGUMENTS=b;c=a.feedbackServerUri||"//www.google.com/tools/feedback";if(f=d.GOOGLE_FEEDBACK_START)f.apply(d,
...
a:{g=pd(e);if(g.defaultView&&g.defaultView.getComputedStyle&&(g=g.defaultView.getComputedStyle(e,null))){g=g.direction||g.getPropertyValue("direction")||"";break a}g=""}g="rtl"==(g||(e.currentStyle?e.currentStyle.direction:null)||e.style&&e.style.direction)?"rtl":"ltr";if(a.completionStyle===2&&!ri("https://gstatic.com/uservoice/surveys/resources/"+c+"/js/survey/survey_"+d+"_"+g+".css")){si();e=document.createElement("link");a:{c=S(hi,c,d,g);if(c instanceof Tc)e.href=Uc(c).toString();else{if(kd.indexOf("stylesheet")===
-1)throw Error('TrustedResourceUrl href attribute required with rel="stylesheet"');c=hd(c);if(c===void 0)break a;e.href=c}e.rel="stylesheet"}document.head.appendChild(e)}ti(this,a,b)}else a.listener&&a.listener.surveyPrompted&&a.listener.surveyPrompted(a.surveyData,{reason:"Invalid completion style"})}else a.listener&&a.listener.surveyPrompted&&a.listener.surveyPrompted(a.surveyData,{reason:"Invalid prompt style"})}};
...
m.ed=function(a){if(!oi(a.triggerId))throw Error("Invalid triggerId");pi(this,a,!0).then(function(b){b({surveyData:null,triggerId:a.triggerId,surveyId:a.surveyIdForTestingMode,surveyError:{reason:"Survey scheduled for later."}})}.bind(this,a.callback),function(b){var c="";try{c=JSON.stringify(b)}catch(d){c="message: "+b.message+", stack: "+b.stack}a.callback({surveyData:null,triggerId:a.triggerId,surveyError:{reason:"Failed to trigger survey: "+c}})})};m.Yc=function(a,b,c){Ri().register(a,b,c)};
m.Jc=function(a,b){Ri().execute(a,b)};m.Nc=function(a){return Ri().ab(a)};
var Si=function(a,b){if(b.enableFeedback1pEndpoint&&b.enableTestingMode)return a.Ia=Wg(new Vg,Rg(!0)),Promise.resolve(a.Ia);if(!a.na||!"5029404 5319991 5171319 237 107539 5092034 5096175 5236060 5105063 5189701 713680 96485 17 5145261 5230404 717991 718565".split(" ").includes(a.na.toString()))return Promise.resolve(a.Ia);b=new te({Db:b.nonProd?"https://stagingqual-feedback-pa-googleapis.sandbox.google.com":"https://feedback-pa.clients6.google.com",apiKey:"AIzaSyCB6OnnfuitFnaYWu4BvtGKaoLFk4cm-GE",
authUser:b.authuser});var c=Ug(new Tg,(a.na||"").toString()).Ga(1);return ue(b,"POST","v1/survey/startup_config",c,Vg).then(function(d){return a.Ia=d})},pi=function(a,b,c){return Si(a,b).then(function(d){if(O(M(d,Qg,1),1)){d=new te({Db:b.nonProd?"https://stagingqual-feedback-pa-googleapis.sandbox.google.com":"https://feedback-pa.clients6.google.com",apiKey:a.Z,authUser:b.authuser});var e=Ti(a,b),g=ze();g=(new Hg).Ob(g);var f=(new Ig).Ga(1).Kb(438217234).Mb([1,2]),h=b.preferredSurveyLanguageList&&
b.preferredSurveyLanguageList.length>0?b.preferredSurveyLanguageList:[a.ha];h=(new Sg).Qb(b.triggerId).Ib(h).Nb(!!b.enableTestingMode);b.surveyIdForTestingMode!=""&&b.surveyIdForTestingMode!=void 0&&b.enableTestingMode==1&&h.Ha(b.surveyIdForTestingMode);g=(new Xg).Pb(h).Eb((new Jg).Fb(g).Jb(f));c!=""&&c!=void 0&&c==1&&g.Lb((new Og).Hb(c));d=ue(d,"POST",e,g,Yg)}else d=Ui(a,b,c);return d},function(){return Ui(a,b,c)})},Ti=function(a,b){var c=[];var d=d===void 0?!1:d;var e=Zg(String(y.location.href));
var g=[];var f=d;f=f===void 0?!1:f;var h=y.__SAPISID||y.__APISID||y.__3PSAPISID||y.__OVERRIDE_SID;gh(f)&&(h=h||y.__1PSAPISID);if(h)f=!0;else{if(typeof document!=="undefined"){var k=new eh;h=k.get("SAPISID")||k.get("APISID")||k.get("__Secure-3PAPISID");gh(f)&&(h=h||k.get("__Secure-1PAPISID"))}f=!!h}f&&(f=(e=e.indexOf("https:")==0||e.indexOf("chrome-extension:")==0||e.indexOf("moz-extension:")==0)?y.__SAPISID:y.__APISID,f||typeof document==="undefined"||(f=new eh,f=f.get(e?"SAPISID":"APISID")||f.get("__Secure-3PAPISID")),
(f=f?bh(f,e?"SAPISIDHASH":"APISIDHASH",c):null)&&g.push(f),e&&gh(d)&&((d=hh("__1PSAPISID","__Secure-1PAPISID","SAPISID1PHASH",c))&&g.push(d),(c=hh("__3PSAPISID","__Secure-3PAPISID","SAPISID3PHASH",c))&&g.push(c)));g=g.length==0?null:g.join(" ");b.thirdPartyDomainSupportEnabled!=void 0&&b.thirdPartyDomainSupportEnabled&&(a.tc=!0,g=!1);return g?"v1/survey/trigger":"v1/survey/trigger/trigger_anonymous"},Ui=function(a,b,c){var d=new te({Db:b.nonProd?"https://test-scone-pa-googleapis.sandbox.google.com":
...
1&&b.Lb((new He).Hb(c));return ue(d,"POST",e,b,Le)},oi=function(a){return typeof a=="string"&&!!a.match(/^[A-Za-z0-9]+$/)},qi=function(a){try{var b=parseInt(Bc(M(a.Qa().ub(),V,1)),10);isNaN(b)&&(b=0)}catch(d){b=0}try{var c=parseInt(Bc(M(a.Qa().ub(),V,2)),10);isNaN(c)&&(c=0)}catch(d){c=0}return Math.floor(Math.random()*(c-b+1))+b},ti=function(a,b,c){var d=c.nonProd?"nonprod":"prod",e=c.language&&Bg[c.language.toLowerCase()]?Bg[c.language.toLowerCase()]:Bg[a.ha.toLowerCase()];e=e&&e.replace("-","_");
e==="fa"&&(e="en");var g=e?encodeURI(e):"en";b.enableReloadScriptWhenLanguageChanges&&!Vi("https://www.gstatic.com/uservoice/surveys/resources/"+d+"/js/survey/survey_binary__"+g+".js")&&Wi();window.hatsNextGlobalObject?Xi(b,c):(e=document.createElement("script"),d=S(gi,d,g),nd(e,d),e.type="text/javascript",e.onload=function(){return Xi(b,c)},e.onerror=function(){b.listener&&b.listener.surveyPrompted&&b.listener.surveyPrompted(c,{reason:"Failed to load survey binary"})},e.setAttribute("data-survey-binary",
...
c=!1;break a}}else if(ii>b.triggerRequestTime){a.listener&&a.listener.surveyPrompted&&a.listener.surveyPrompted(b,{reason:"Survey must be triggered after initializing the help API."});c=!1;break a}c=Date.now()-b.triggerRequestTime;c>864E5?(a.listener&&a.listener.surveyPrompted&&a.listener.surveyPrompted(b,{reason:"Survey must be triggered within the last 24 hours. Survey was triggered "+(c+" ms ago.")}),c=!1):c=!0}if(c){var d,e,g;window.hatsNextGlobalObject.initSurvey({surveyTriggerResponse:b.surveyData,
