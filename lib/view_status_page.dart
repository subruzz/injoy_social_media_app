...
class ViewStatusPage extends StatefulWidget {
  final AllStatusEntity statusEntity;
...
class _MoreStoriesState extends State<ViewStatusPage> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: BlocBuilder<GetMyStatusBloc, GetMyStatusState>(
            ...
            return Scaffold(
              body: Stack(
                children: [
                  StoryView(
                    storyItems: [
                      for (final status in widget.statusEntity. allStatuses)
                        StoryItem.text(
                    ...
                    onStoryShow: (storyItem, index) {
                      ...
                      context.read<StatusBloc>().add(SeenStatusUpateEvent(
                          uId: widget.statusEntity. statusEntity.uId,
                          sId: widget.statusEntity. allStatuses[index].statusId,
                            ...
                            children: [
                              CircleAvatar(
                                backgroundImage: state
                                            .myStatus.statusEntity.profilePic !=
                                        null
                                    ? NetworkImage(
                                        widget.statusEntity. statusEntity.profilePic!,
                                      )
                                    : const AssetImage(
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    widget.statusEntity.statusEntity.userName,
                                  ...
                                  ValueListenableBuilder(
                                    ...
                                    builder: (BuildContext context,
                                      ...
                                      return Text(
                                        widget.statusEntity. allStatuses[value]
                                            .timestamp
                                            .toDate()
                                            .timeAgo(),
                                        style: Theme.of(context)
